$PBExportHeader$w_user_add.srw
forward
global type w_user_add from window
end type
type gr_1 from graph within w_user_add
end type
end forward
...
global w_user_add w_user_add

on w_user_add.create
this.gr_1=create gr_1
this.Control[]={this.gr_1}
end on

on w_user_add.destroy
destroy(this.gr_1)
end on
